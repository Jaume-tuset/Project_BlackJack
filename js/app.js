(() =>{
    ...
    const partidasGanadasElement = document.getElementById('partidas-ganadas');
    const partidasPerdidasElement = document.getElementById('partidas-perdidas');
    ...
    const turnoComputadora = ( puntosMinimos )=>{
        ...
        btnNuevo.addEventListener('click', ()=>{
            ...
            actualizarPartidasTotales();
        })

  
        // Para actualizar el conteo de partidas ganadas y perdidas
        const ganarPartida = () => {
          const partidasGanadas = parseInt(partidasGanadasElement.innerText, 10);
          partidasGanadasElement.innerText = partidasGanadas + 1;
        };
        
        const perderPartida = () => {
          const partidasPerdidas = parseInt(partidasPerdidasElement.innerText, 10);
          partidasPerdidasElement.innerText = partidasPerdidas + 1;
        };

        const actualizarPartidasTotales = () => {
            const partidasTotalesElement = document.getElementById('partidas-totales');
            const partidasTotales = parseInt(partidasTotalesElement.innerText, 10);
            partidasTotalesElement.innerText = partidasTotales + 1;
        };
